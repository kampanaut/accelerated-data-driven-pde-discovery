...
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-1-1step-k800-baseline.yaml

echo "=== TRAIN [2/48] br-2-1step-k10-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-2-1step-k10-baseline.yaml

echo "=== TRAIN [3/48] br-3-1step-k800-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-3-1step-k800-metal.yaml

echo "=== TRAIN [4/48] br-4-1step-k10-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-4-1step-k10-metal.yaml

echo "=== TRAIN [5/48] br-5-1step-k800-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-5-1step-k800-spectral.yaml

echo "=== TRAIN [6/48] br-6-1step-k10-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-6-1step-k10-spectral.yaml

echo "=== TRAIN [7/48] br-7-1step-k800-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-7-1step-k800-metal-spectral.yaml

echo "=== TRAIN [8/48] br-8-1step-k10-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-8-1step-k10-metal-spectral.yaml

echo "=== TRAIN [9/48] br-9-5step-k800-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-9-5step-k800-baseline.yaml

echo "=== TRAIN [10/48] br-10-5step-k10-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-10-5step-k10-baseline.yaml

echo "=== TRAIN [11/48] br-11-5step-k800-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-11-5step-k800-metal.yaml

echo "=== TRAIN [12/48] br-12-5step-k10-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-12-5step-k10-metal.yaml

echo "=== TRAIN [13/48] br-13-5step-k800-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-13-5step-k800-spectral.yaml

echo "=== TRAIN [14/48] br-14-5step-k10-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-14-5step-k10-spectral.yaml

echo "=== TRAIN [15/48] br-15-5step-k800-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-15-5step-k800-metal-spectral.yaml

echo "=== TRAIN [16/48] br-16-5step-k10-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/br-16-5step-k10-metal-spectral.yaml

echo "=== TRAIN [17/48] heat-17-1step-k800-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-17-1step-k800-baseline.yaml

echo "=== TRAIN [18/48] heat-18-1step-k10-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-18-1step-k10-baseline.yaml

echo "=== TRAIN [19/48] heat-19-1step-k800-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-19-1step-k800-metal.yaml

echo "=== TRAIN [20/48] heat-20-1step-k10-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-20-1step-k10-metal.yaml

echo "=== TRAIN [21/48] heat-21-1step-k800-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-21-1step-k800-spectral.yaml

echo "=== TRAIN [22/48] heat-22-1step-k10-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-22-1step-k10-spectral.yaml

echo "=== TRAIN [23/48] heat-23-1step-k800-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-23-1step-k800-metal-spectral.yaml

echo "=== TRAIN [24/48] heat-24-1step-k10-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-24-1step-k10-metal-spectral.yaml

echo "=== TRAIN [25/48] heat-25-5step-k800-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-25-5step-k800-baseline.yaml

echo "=== TRAIN [26/48] heat-26-5step-k10-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-26-5step-k10-baseline.yaml

echo "=== TRAIN [27/48] heat-27-5step-k800-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-27-5step-k800-metal.yaml

echo "=== TRAIN [28/48] heat-28-5step-k10-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-28-5step-k10-metal.yaml

echo "=== TRAIN [29/48] heat-29-5step-k800-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-29-5step-k800-spectral.yaml

echo "=== TRAIN [30/48] heat-30-5step-k10-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-30-5step-k10-spectral.yaml

echo "=== TRAIN [31/48] heat-31-5step-k800-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-31-5step-k800-metal-spectral.yaml

echo "=== TRAIN [32/48] heat-32-5step-k10-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed/heat-32-5step-k10-metal-spectral.yaml
...
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-1-1step-k800-baseline.yaml

echo "=== EVAL [2/48] br-2-1step-k10-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-2-1step-k10-baseline.yaml

echo "=== EVAL [3/48] br-3-1step-k800-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-3-1step-k800-metal.yaml

echo "=== EVAL [4/48] br-4-1step-k10-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-4-1step-k10-metal.yaml

echo "=== EVAL [5/48] br-5-1step-k800-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-5-1step-k800-spectral.yaml

echo "=== EVAL [6/48] br-6-1step-k10-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-6-1step-k10-spectral.yaml

echo "=== EVAL [7/48] br-7-1step-k800-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-7-1step-k800-metal-spectral.yaml

echo "=== EVAL [8/48] br-8-1step-k10-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-8-1step-k10-metal-spectral.yaml

echo "=== EVAL [9/48] br-9-5step-k800-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-9-5step-k800-baseline.yaml

echo "=== EVAL [10/48] br-10-5step-k10-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-10-5step-k10-baseline.yaml

echo "=== EVAL [11/48] br-11-5step-k800-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-11-5step-k800-metal.yaml

echo "=== EVAL [12/48] br-12-5step-k10-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-12-5step-k10-metal.yaml

echo "=== EVAL [13/48] br-13-5step-k800-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-13-5step-k800-spectral.yaml

echo "=== EVAL [14/48] br-14-5step-k10-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-14-5step-k10-spectral.yaml

echo "=== EVAL [15/48] br-15-5step-k800-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-15-5step-k800-metal-spectral.yaml

echo "=== EVAL [16/48] br-16-5step-k10-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/br-16-5step-k10-metal-spectral.yaml

echo "=== EVAL [17/48] heat-17-1step-k800-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-17-1step-k800-baseline.yaml

echo "=== EVAL [18/48] heat-18-1step-k10-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-18-1step-k10-baseline.yaml

echo "=== EVAL [19/48] heat-19-1step-k800-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-19-1step-k800-metal.yaml

echo "=== EVAL [20/48] heat-20-1step-k10-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-20-1step-k10-metal.yaml

echo "=== EVAL [21/48] heat-21-1step-k800-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-21-1step-k800-spectral.yaml

echo "=== EVAL [22/48] heat-22-1step-k10-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-22-1step-k10-spectral.yaml

echo "=== EVAL [23/48] heat-23-1step-k800-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-23-1step-k800-metal-spectral.yaml

echo "=== EVAL [24/48] heat-24-1step-k10-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-24-1step-k10-metal-spectral.yaml

echo "=== EVAL [25/48] heat-25-5step-k800-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-25-5step-k800-baseline.yaml

echo "=== EVAL [26/48] heat-26-5step-k10-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-26-5step-k10-baseline.yaml

echo "=== EVAL [27/48] heat-27-5step-k800-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-27-5step-k800-metal.yaml

echo "=== EVAL [28/48] heat-28-5step-k10-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-28-5step-k10-metal.yaml

echo "=== EVAL [29/48] heat-29-5step-k800-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-29-5step-k800-spectral.yaml

echo "=== EVAL [30/48] heat-30-5step-k10-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-30-5step-k10-spectral.yaml

echo "=== EVAL [31/48] heat-31-5step-k800-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-31-5step-k800-metal-spectral.yaml

echo "=== EVAL [32/48] heat-32-5step-k10-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed/heat-32-5step-k10-metal-spectral.yaml
...
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-1-1step-k800-baseline.yaml

echo "=== VIS [2/48] br-2-1step-k10-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-2-1step-k10-baseline.yaml

echo "=== VIS [3/48] br-3-1step-k800-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-3-1step-k800-metal.yaml

echo "=== VIS [4/48] br-4-1step-k10-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-4-1step-k10-metal.yaml

echo "=== VIS [5/48] br-5-1step-k800-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-5-1step-k800-spectral.yaml

echo "=== VIS [6/48] br-6-1step-k10-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-6-1step-k10-spectral.yaml

echo "=== VIS [7/48] br-7-1step-k800-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-7-1step-k800-metal-spectral.yaml

echo "=== VIS [8/48] br-8-1step-k10-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-8-1step-k10-metal-spectral.yaml

echo "=== VIS [9/48] br-9-5step-k800-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-9-5step-k800-baseline.yaml

echo "=== VIS [10/48] br-10-5step-k10-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-10-5step-k10-baseline.yaml

echo "=== VIS [11/48] br-11-5step-k800-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-11-5step-k800-metal.yaml

echo "=== VIS [12/48] br-12-5step-k10-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-12-5step-k10-metal.yaml

echo "=== VIS [13/48] br-13-5step-k800-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-13-5step-k800-spectral.yaml

echo "=== VIS [14/48] br-14-5step-k10-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-14-5step-k10-spectral.yaml

echo "=== VIS [15/48] br-15-5step-k800-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-15-5step-k800-metal-spectral.yaml

echo "=== VIS [16/48] br-16-5step-k10-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/br-16-5step-k10-metal-spectral.yaml

echo "=== VIS [17/48] heat-17-1step-k800-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-17-1step-k800-baseline.yaml

echo "=== VIS [18/48] heat-18-1step-k10-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-18-1step-k10-baseline.yaml

echo "=== VIS [19/48] heat-19-1step-k800-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-19-1step-k800-metal.yaml

echo "=== VIS [20/48] heat-20-1step-k10-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-20-1step-k10-metal.yaml

echo "=== VIS [21/48] heat-21-1step-k800-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-21-1step-k800-spectral.yaml

echo "=== VIS [22/48] heat-22-1step-k10-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-22-1step-k10-spectral.yaml

echo "=== VIS [23/48] heat-23-1step-k800-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-23-1step-k800-metal-spectral.yaml

echo "=== VIS [24/48] heat-24-1step-k10-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-24-1step-k10-metal-spectral.yaml

echo "=== VIS [25/48] heat-25-5step-k800-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-25-5step-k800-baseline.yaml

echo "=== VIS [26/48] heat-26-5step-k10-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-26-5step-k10-baseline.yaml

echo "=== VIS [27/48] heat-27-5step-k800-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-27-5step-k800-metal.yaml

echo "=== VIS [28/48] heat-28-5step-k10-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-28-5step-k10-metal.yaml

echo "=== VIS [29/48] heat-29-5step-k800-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-29-5step-k800-spectral.yaml

echo "=== VIS [30/48] heat-30-5step-k10-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-30-5step-k10-spectral.yaml

echo "=== VIS [31/48] heat-31-5step-k800-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-31-5step-k800-metal-spectral.yaml

echo "=== VIS [32/48] heat-32-5step-k10-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed/heat-32-5step-k10-metal-spectral.yaml
