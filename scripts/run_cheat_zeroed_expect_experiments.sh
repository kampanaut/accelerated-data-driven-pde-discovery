...
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-17-1step-k800-baseline.yaml

echo "=== TRAIN [18/48] heat-18-1step-k10-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-18-1step-k10-baseline.yaml

echo "=== TRAIN [19/48] heat-19-1step-k800-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-19-1step-k800-metal.yaml

echo "=== TRAIN [20/48] heat-20-1step-k10-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-20-1step-k10-metal.yaml

echo "=== TRAIN [21/48] heat-21-1step-k800-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-21-1step-k800-spectral.yaml

echo "=== TRAIN [22/48] heat-22-1step-k10-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-22-1step-k10-spectral.yaml

echo "=== TRAIN [23/48] heat-23-1step-k800-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-23-1step-k800-metal-spectral.yaml

echo "=== TRAIN [24/48] heat-24-1step-k10-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-24-1step-k10-metal-spectral.yaml

echo "=== TRAIN [25/48] heat-25-5step-k800-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-25-5step-k800-baseline.yaml

echo "=== TRAIN [26/48] heat-26-5step-k10-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-26-5step-k10-baseline.yaml

echo "=== TRAIN [27/48] heat-27-5step-k800-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-27-5step-k800-metal.yaml

echo "=== TRAIN [28/48] heat-28-5step-k10-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-28-5step-k10-metal.yaml

echo "=== TRAIN [29/48] heat-29-5step-k800-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-29-5step-k800-spectral.yaml

echo "=== TRAIN [30/48] heat-30-5step-k10-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-30-5step-k10-spectral.yaml

echo "=== TRAIN [31/48] heat-31-5step-k800-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-31-5step-k800-metal-spectral.yaml

echo "=== TRAIN [32/48] heat-32-5step-k10-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/heat-32-5step-k10-metal-spectral.yaml

echo "=== TRAIN [33/48] nl_heat-33-1step-k800-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-33-1step-k800-baseline.yaml

echo "=== TRAIN [34/48] nl_heat-34-1step-k10-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-34-1step-k10-baseline.yaml

echo "=== TRAIN [35/48] nl_heat-35-1step-k800-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-35-1step-k800-metal.yaml

echo "=== TRAIN [36/48] nl_heat-36-1step-k10-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-36-1step-k10-metal.yaml

echo "=== TRAIN [37/48] nl_heat-37-1step-k800-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-37-1step-k800-spectral.yaml

echo "=== TRAIN [38/48] nl_heat-38-1step-k10-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-38-1step-k10-spectral.yaml

echo "=== TRAIN [39/48] nl_heat-39-1step-k800-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-39-1step-k800-metal-spectral.yaml

echo "=== TRAIN [40/48] nl_heat-40-1step-k10-metal-spectral ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-40-1step-k10-metal-spectral.yaml

echo "=== TRAIN [41/48] nl_heat-41-5step-k800-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-41-5step-k800-baseline.yaml

echo "=== TRAIN [42/48] nl_heat-42-5step-k10-baseline ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-42-5step-k10-baseline.yaml

echo "=== TRAIN [43/48] nl_heat-43-5step-k800-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-43-5step-k800-metal.yaml

echo "=== TRAIN [44/48] nl_heat-44-5step-k10-metal ==="
uv run python scripts/train_maml.py --config configs/cheat_zeroed_expect/nl_heat-44-5step-k10-metal.yaml
...
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-17-1step-k800-baseline.yaml

echo "=== EVAL [18/48] heat-18-1step-k10-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-18-1step-k10-baseline.yaml

echo "=== EVAL [19/48] heat-19-1step-k800-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-19-1step-k800-metal.yaml

echo "=== EVAL [20/48] heat-20-1step-k10-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-20-1step-k10-metal.yaml

echo "=== EVAL [21/48] heat-21-1step-k800-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-21-1step-k800-spectral.yaml

echo "=== EVAL [22/48] heat-22-1step-k10-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-22-1step-k10-spectral.yaml

echo "=== EVAL [23/48] heat-23-1step-k800-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-23-1step-k800-metal-spectral.yaml

echo "=== EVAL [24/48] heat-24-1step-k10-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-24-1step-k10-metal-spectral.yaml

echo "=== EVAL [25/48] heat-25-5step-k800-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-25-5step-k800-baseline.yaml

echo "=== EVAL [26/48] heat-26-5step-k10-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-26-5step-k10-baseline.yaml

echo "=== EVAL [27/48] heat-27-5step-k800-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-27-5step-k800-metal.yaml

echo "=== EVAL [28/48] heat-28-5step-k10-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-28-5step-k10-metal.yaml

echo "=== EVAL [29/48] heat-29-5step-k800-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-29-5step-k800-spectral.yaml

echo "=== EVAL [30/48] heat-30-5step-k10-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-30-5step-k10-spectral.yaml

echo "=== EVAL [31/48] heat-31-5step-k800-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-31-5step-k800-metal-spectral.yaml

echo "=== EVAL [32/48] heat-32-5step-k10-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/heat-32-5step-k10-metal-spectral.yaml

echo "=== EVAL [33/48] nl_heat-33-1step-k800-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-33-1step-k800-baseline.yaml

echo "=== EVAL [34/48] nl_heat-34-1step-k10-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-34-1step-k10-baseline.yaml

echo "=== EVAL [35/48] nl_heat-35-1step-k800-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-35-1step-k800-metal.yaml

echo "=== EVAL [36/48] nl_heat-36-1step-k10-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-36-1step-k10-metal.yaml

echo "=== EVAL [37/48] nl_heat-37-1step-k800-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-37-1step-k800-spectral.yaml

echo "=== EVAL [38/48] nl_heat-38-1step-k10-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-38-1step-k10-spectral.yaml

echo "=== EVAL [39/48] nl_heat-39-1step-k800-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-39-1step-k800-metal-spectral.yaml

echo "=== EVAL [40/48] nl_heat-40-1step-k10-metal-spectral ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-40-1step-k10-metal-spectral.yaml

echo "=== EVAL [41/48] nl_heat-41-5step-k800-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-41-5step-k800-baseline.yaml

echo "=== EVAL [42/48] nl_heat-42-5step-k10-baseline ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-42-5step-k10-baseline.yaml

echo "=== EVAL [43/48] nl_heat-43-5step-k800-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-43-5step-k800-metal.yaml

echo "=== EVAL [44/48] nl_heat-44-5step-k10-metal ==="
uv run python scripts/evaluate.py --config configs/cheat_zeroed_expect/nl_heat-44-5step-k10-metal.yaml
...
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-17-1step-k800-baseline.yaml

echo "=== VIS [18/48] heat-18-1step-k10-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-18-1step-k10-baseline.yaml

echo "=== VIS [19/48] heat-19-1step-k800-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-19-1step-k800-metal.yaml

echo "=== VIS [20/48] heat-20-1step-k10-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-20-1step-k10-metal.yaml

echo "=== VIS [21/48] heat-21-1step-k800-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-21-1step-k800-spectral.yaml

echo "=== VIS [22/48] heat-22-1step-k10-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-22-1step-k10-spectral.yaml

echo "=== VIS [23/48] heat-23-1step-k800-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-23-1step-k800-metal-spectral.yaml

echo "=== VIS [24/48] heat-24-1step-k10-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-24-1step-k10-metal-spectral.yaml

echo "=== VIS [25/48] heat-25-5step-k800-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-25-5step-k800-baseline.yaml

echo "=== VIS [26/48] heat-26-5step-k10-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-26-5step-k10-baseline.yaml

echo "=== VIS [27/48] heat-27-5step-k800-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-27-5step-k800-metal.yaml

echo "=== VIS [28/48] heat-28-5step-k10-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-28-5step-k10-metal.yaml

echo "=== VIS [29/48] heat-29-5step-k800-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-29-5step-k800-spectral.yaml

echo "=== VIS [30/48] heat-30-5step-k10-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-30-5step-k10-spectral.yaml

echo "=== VIS [31/48] heat-31-5step-k800-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-31-5step-k800-metal-spectral.yaml

echo "=== VIS [32/48] heat-32-5step-k10-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/heat-32-5step-k10-metal-spectral.yaml

echo "=== VIS [33/48] nl_heat-33-1step-k800-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-33-1step-k800-baseline.yaml

echo "=== VIS [34/48] nl_heat-34-1step-k10-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-34-1step-k10-baseline.yaml

echo "=== VIS [35/48] nl_heat-35-1step-k800-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-35-1step-k800-metal.yaml

echo "=== VIS [36/48] nl_heat-36-1step-k10-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-36-1step-k10-metal.yaml

echo "=== VIS [37/48] nl_heat-37-1step-k800-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-37-1step-k800-spectral.yaml

echo "=== VIS [38/48] nl_heat-38-1step-k10-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-38-1step-k10-spectral.yaml

echo "=== VIS [39/48] nl_heat-39-1step-k800-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-39-1step-k800-metal-spectral.yaml

echo "=== VIS [40/48] nl_heat-40-1step-k10-metal-spectral ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-40-1step-k10-metal-spectral.yaml

echo "=== VIS [41/48] nl_heat-41-5step-k800-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-41-5step-k800-baseline.yaml

echo "=== VIS [42/48] nl_heat-42-5step-k10-baseline ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-42-5step-k10-baseline.yaml

echo "=== VIS [43/48] nl_heat-43-5step-k800-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-43-5step-k800-metal.yaml

echo "=== VIS [44/48] nl_heat-44-5step-k10-metal ==="
uv run python scripts/visualize.py --config configs/cheat_zeroed_expect/nl_heat-44-5step-k10-metal.yaml
