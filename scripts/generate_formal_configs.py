    ...
    (
        VariantMeta("the-finals-sobol", "configs/the-finals-sobol", "data/models/the-finals-sobol"),
        {
            ...
            "loss_preset": Preset([
                ...
                ("100x120x300-anil-bypass", {
                    "max_iterations": 2000,
                    "meta_batch_size": 25,
                    "hidden_dims": [100, 120, 300],
                    "input_bypass": True,
                    "imaml": {"enabled": True, "lam": 0.005, "cg_steps": 10,
                              "cg_damping": 1.0, "inner_optimizer": "lbfgs",
                              "anil": True,
                ...
                ("100x120x150x300-anil", {
                    "max_iterations": 2000,
                    "meta_batch_size": 25,
                    "hidden_dims": [100, 120, 150, 300],
                    "imaml": {"enabled": True, "lam": 0.005, "cg_steps": 10,
                              "cg_damping": 1.0, "inner_optimizer": "lbfgs",
                              "anil": True,
                              "proximal_every_step": False},
                ...
                ("32x32x32x32x32x300-anil", {
                    "max_iterations": 2000,
                    "meta_batch_size": 25,
                    "hidden_dims": [32, 32, 32, 32, 32, 300],
                    "imaml": {"enabled": True, "lam": 0.005, "cg_steps": 10,
                              "cg_damping": 1.0, "inner_optimizer": "lbfgs",
                              "anil": True,
                              "proximal_every_step": False},
                ...
                ("32x64x72x128x136x245x300-anil", {
                    "max_iterations": 2000,
                    "meta_batch_size": 25,
                    "hidden_dims": [32, 64, 72, 128, 136, 245, 300],
                    "imaml": {"enabled": True, "lam": 0.005, "cg_steps": 10,
                              "cg_damping": 1.0, "inner_optimizer": "lbfgs",
                              "anil": True,
                              "proximal_every_step": False},
                ...
                ("116x228x339x450-anil", {
                    "max_iterations": 2000,
                    "meta_batch_size": 25,
                    "outer_lr": 0.007,
                    "hidden_dims": [116, 228, 339, 450],
                    "imaml": {"enabled": True, "lam": 0.005, "cg_steps": 10,
                              "cg_damping": 1.0, "inner_optimizer": "lbfgs",
                              "anil": True,
                              "proximal_every_step": False},
                ...
                ("100x150x300x600-anil", {
                    "max_iterations": 2000,
                    "meta_batch_size": 25,
                    "outer_lr": 0.005,
                    "hidden_dims": [100, 150, 300, 600],
                    "imaml": {"enabled": True, "lam": 0.005, "cg_steps": 10,
                              "cg_damping": 1.0, "inner_optimizer": "lbfgs",
                              "anil": True,
                              "proximal_every_step": False},
                ...
                ("94x183x272x361x450-anil", {
                    "max_iterations": 2000,
                    "meta_batch_size": 25,
                    "outer_lr": 0.007,
                    "hidden_dims": [94, 183, 272, 361, 450],
                    "imaml": {"enabled": True, "lam": 0.005, "cg_steps": 10,
                              "cg_damping": 1.0, "inner_optimizer": "lbfgs",
                              "anil": True,
                              "proximal_every_step": False},
                ...
                ("100x120x150x450-anil", {
                    "max_iterations": 2000,
                    "meta_batch_size": 25,
                    "outer_lr": 0.007,
                    "hidden_dims": [100, 120, 150, 450],
                    "imaml": {"enabled": True, "lam": 0.005, "cg_steps": 10,
                              "cg_damping": 1.0, "inner_optimizer": "lbfgs",
                              "anil": True,
                              "proximal_every_step": False},
